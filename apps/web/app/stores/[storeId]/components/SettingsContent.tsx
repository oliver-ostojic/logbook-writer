...
import { StoreRulesSection, DefaultRolesSection, InviteCodesSection } from '../settings/components';
...
export function SettingsContent({ storeId, onNavChange }: SettingsContentProps) {
        ...
        <div className="flex flex-col min-[1200px]:flex-row gap-6 min-[1200px]:justify-center">
          <div className="w-full settings-container">
            ...
            <div className="flex flex-col gap-6">
              <TopNavHeader storeId={storeId} activeNav="settings" onNavChange={onNavChange} />
                  ...
                  <div style={{ width: '70%', transition: 'width 0.3s ease' }}>
                    ...
                    {activeView === 'addStoreRule' && (
                      <RoleRuleForm
                        ...
                        onCancel={() => setActiveView('storeRules')}
                      />
                    )}
