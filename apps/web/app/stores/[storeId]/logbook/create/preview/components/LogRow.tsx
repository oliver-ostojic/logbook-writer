...
export default function LogRow() {
  return (
    <div className="flex h-full flex-col">
      <header className="flex flex-none items-center justify-between border-b border-gray-200 pb-4 pt-1">
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-3">
            <h3
              className="text-3xl font-medium text-gray-700 tracking-tight"
              style={{ fontFamily: 'var(--font-heading)' }}
            >
              Logbook View
            </h3>
            <span className="inline-flex items-center rounded-md border border-dashed border-gray-300 bg-transparent px-3 py-2 text-sm font-semibold text-gray-600">
              Draft
            </span>
          </div>
